...
(() => {
 ...
 const CACHE_KEY='ranasports-news-csv-v2:'+siteBase.pathname;
 ...
 function imageURL(value){
  ...
  /* Una URL de post de Instagram nunca se incrusta en el espacio de foto. Debe cargarse una URL directa de imagen. */
